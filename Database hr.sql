...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2021 at 06:36 PM
...
(3, 7, 3, 'Baner 5', '1619407422_26c58dc5a26c9a3f38e8.pdf'),
(4, 10, 1, 'Curiculum Vitae', '1619587094_41d0f605a31abedaad66.pdf'),
(5, 10, 3, 'Piagam Jakarta', '1619587184_b960f995ee3f17a763bc.pdf'),
(6, 11, 1, 'Curiculum Vitae', '1619599744_723b2670ede7aa3e394b.pdf');
...
CREATE TABLE `tb_bidang` (
  `id_bidang` char(4) NOT NULL,
  `id_spesialisasi` char(2) NOT NULL,
...
INSERT INTO `tb_bidang` (`id_bidang`, `id_spesialisasi`, `nama_bidang`) VALUES
('1101', '11', 'HRD Umum'),
('1301', '13', 'Website Developer'),
('1302', '13', 'Mobile Developer'),
('1303', '13', 'Software Developer'),
('1401', '14', 'Editor'),
('1402', '14', 'Jurnalis/Penulis'),
('1501', '15', 'Sales - Enginering/Teknikal/IT'),
('1601', '16', 'Manajemen'),
('1602', '16', 'Sekretaris/Asisten Pribadi');
...
CREATE TABLE `tb_calkar` (
  ...
  `id_spesialisasi` int(2) DEFAULT NULL,
  `id_bidang` int(3) DEFAULT NULL,
  `id_skill` int(4) NOT NULL,
  `jabatan` varchar(255) DEFAULT NULL,
  `kemampuan` varchar(255) DEFAULT NULL,
  `stat_pendaftaran` int(1) DEFAULT 0,
  `stat_calkar` int(1) DEFAULT 0,
  `tipe_kar` varchar(255) DEFAULT NULL,
...
INSERT INTO `tb_calkar` (`id_calkar`, `email`, `nama_lengkap`, `pendidikan`, `password`, `foto`, `tempat_lahir`, `tgl_lahir`, `alamat`, `agama`, `no_telpon`, `jk`, `id_provinsi`, `id_kabupaten`, `id_kecamatan`, `id_spesialisasi`, `id_bidang`, `id_skill`, `jabatan`, `kemampuan`, `stat_pendaftaran`, `stat_calkar`, `tipe_kar`, `masa_kontrak`, `bidang`, `star`) VALUES
(2, 'dimasbudipratama0@gmail.com', 'dimas budi', 'D3', '12345', '1617727067_3c63daaa054b4401f8bb.jpg', 'Bandar Lampung', '2021-04-21', 'jl Pulau Damar No 46', 'Islam', '082279137077', 'L', 18, 1871, 1871090, 13, 1301, 1102052, NULL, NULL, 0, 0, 'Freelance', '2021-07-16', 'Web Developer', 4),
(7, 'alinsanovsagita7@gmail.com', 'alinsa', 'SMK', '12345', '1619407259_64d0eb79ed8664c668c7.jpg', 'Bandar Lampung', '0008-04-12', 'jl Pulau Damar No 46', 'Islam', '76756', 'L', 11, 1101, 1101010, 11, 1101, 0, 'CEO', NULL, 1, 1, 'Kontrak', '2021-04-06', 'Web Developer', 0),
(8, 'irhamdinata01@gmail.com', 'Irham Dinata', NULL, '12345', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 1, 0, NULL, NULL, NULL, 0),
(11, 'febiolatrimelina1111@gmail.com', 'febiola tri melina', 'D3', 'febiola24', '1619599870_be87e77631d06d9e1797.png', 'Bandar Lampung', '0008-04-12', 'jl Pulau Damar No 46', 'Islam', '08765', 'P', 18, 1802, 1802043, 13, 1301, 0, 'Pegawai', NULL, 1, 1, 'Kontrak', '2021-04-15', 'Web Developer', 4);
...
INSERT INTO `tb_jabatan` (`id_skill`, `id_bidang`, `nama_jabatan`) VALUES
('1101010', '1101', 'Compensation and Benefit'),
('1101020', '1101', 'Personnel Administration'),
('1101021', '1101', 'Penilaian Kinerja'),
('1102010', '1301', 'Analisis Sistem'),
('1102020', '1301', 'Arsitek Perangkat Lunak'),
('1102030', '1301', 'Administrator Database'),
('1102040', '1301', 'Administrator Sistem'),
('1102051', '1301', 'Front End Developer'),
('1102052', '1301', 'Back End Developer'),
('1102055', '1301', 'Full Stack Developer'),
('1102056', '1301', 'UI/UX Designer'),
('1102110', '1302', 'Analisis Sistem'),
('1102120', '1302', 'Arsitek Perangkat Lunak'),
('1102130', '1302', 'Administrator Database'),
('1102140', '1302', 'Administrator Sistem'),
('1102151', '1302', 'Front End Developer'),
('1102152', '1302', 'Back End Developer'),
('1102155', '1302', 'Full Stack Developer'),
('1102156', '1302', 'UI/UX Designer'),
('1102210', '1303', 'Analisis Sistem'),
('1102220', '1303', 'Arsitek Perangkat Lunak'),
('1102230', '1303', 'Administrator Database'),
('1102240', '1303', 'Administrator Sistem'),
('1102251', '1303', 'Front End Developer'),
('1102252', '1303', 'Back End Developer'),
('1102255', '1303', 'Full Stack Developer'),
('1102256', '1303', 'UI/UX Designer'),
('1103010', '1401', 'Video Animasi'),
('1103020', '1401', 'Video Editing'),
('1103110', '1402', 'Reporter'),
('1103210', '1402', 'Wartawan'),
('1104010', '1501', 'Eksekutif Penjualan/Manajer Akun'),
('1104020', '1501', 'Konsultan Pra-Penjualan'),
('1104030', '1501', 'Manajemen'),
('1104040', '1501', 'Teknisi Penjualan');
...
INSERT INTO `tb_kehadiran` (`id_kehadiran`, `nm_kehadiran`, `tipe_kar`, `bulan`, `tahun`, `izin`, `cuti`, `alfa`) VALUES
(8, 'Irham', 'Kontrak', 'Febuari', '2021', 2, 22, 2),
(9, 'Irham', 'Tetap', 'April', '2020', 2131, 22, 31),
(10, 'Febiola', 'Kontrak', 'Febuari', '2020', 1, 3, 3),
(11, 'Dimas', 'Tetap', 'Maret', '2021', 2, 2, 2);
...
INSERT INTO `tb_kontrak` (`id_kontrak`, `nama_karyawan`, `status`, `tgl_mulai`, `tgl_berakhir`, `nama_project`, `bidang`, `surat`, `ukuran_file`) VALUES
(13, 'Dimas Budi Pratama', 'Freelance', '2021-04-01', '2021-05-14', 'Aplikasi HR', 'Web Developer', '1619359822_bad4cd3e7ed78a3d95f0.pdf', 57701),
(14, 'asas', 'kontrak', '2021-04-20', '2021-05-14', 'asa', NULL, NULL, NULL);
...
INSERT INTO `tb_setting` (`id`, `nama_perusahaan`, `alamat`, `no_telpon`, `email`, `web`, `sosial_media`, `deskripsi`, `logo`, `beranda`) VALUES
(1, 'GiNK Technology', 'Pahoman', '082279137077', 'dimasbudipratama0@.gmail.com', 'http://www.ginktechnology.com', '@GinkTechnology', 'Software House : Web Devlopment', '1617091165_4324dcb9d31b327df3e8.png', '<p>Deskripsi Pekerjaan</p>\r\n\r\n<ul>\r\n	<li>Candidate must possess at least Bachelor&#39;s Degree in Engineering (Computer/Telecommunication), Computer Science/Information Technology, Computer Engineering or equivalent.</li>\r\n	<li>Mastering PHP (OOP and Procedural)</li>\r\n	<li>Required language(s):&nbsp;Bahasa Indonesia</li>\r\n	<li>At least 1&nbsp;Year(s) of working experience in the related field is required for this position.</li>\r\n	<li>Required Skill(s):</li>\r\n	<li>Programming And Database</li>\r\n	<li>Frontend : HTML5, CSS3, Javascript</li>\r\n	<li>Backend : PHP (minimum version 5.6)</li>\r\n	<li>Database :&nbsp;MySQL/MariaDB/PostgreSQL</li>\r\n	<li>Framework &amp; Library:&nbsp;</li>\r\n	<li>CodeIgniter/Laravel (MVC Concept)</li>\r\n	<li>Bootstrap 4/Material Design</li>\r\n	<li>JQuery, Datatables</li>\r\n	<li>Basic Networking TCP/IP</li>\r\n	<li>Basic Linux</li>\r\n	<li>Experienced in working on website-based applications&nbsp;</li>\r\n	<li>Preferably Staff (non-management &amp; non-supervisor) specialized in IT/Computer - Software or equivalent.</li>\r\n</ul>\r\n');
...
INSERT INTO `tb_skill` (`id_skill`, `id_bidang`, `nama_skill`) VALUES
('1101010', '1101', 'Compensation and Benefit'),
('1101020', '1101', 'Personnel Administration'),
('1101021', '1101', 'Penilaian Kinerja'),
('1102010', '1301', 'Analisis Sistem'),
...
INSERT INTO `tb_spesialisasi` (`id_spesialisasi`, `nama_spesialisasi`) VALUES
('11', 'HRD'),
('13', 'IT/Komputer - Perangkat Lunak'),
('14', 'Editor'),
('15', 'Sales Engineering'),
('16', 'Sekretaris/Personal Assistant');
...
--
ALTER TABLE `tb_calkar`
  MODIFY `id_calkar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_kontrak`
  MODIFY `id_kontrak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
